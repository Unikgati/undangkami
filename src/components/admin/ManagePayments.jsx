    ...
    return (
        ...
        >
            ...
            <Card className="glass-effect border-none text-white shadow-lg">
                ...
                <CardContent>
                    {loading ? (
                        <div className="text-blue-700 font-semibold">Memuat daftar rekening...</div>
                    ) : payments.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 mt-2 w-full">
                            {payments.map((p) => (
                                <div
                                    key={p.id}
                                    className="glass-effect bg-gradient-to-br from-purple-900/40 via-blue-900/30 to-white/10 backdrop-blur-md rounded-2xl px-3 py-6 flex flex-col items-start gap-2 border border-purple-300 shadow-lg hover:scale-[1.03] hover:shadow-2xl transition-all duration-200 cursor-pointer"
