        ...
        >
            ...
            {showDeleteModal && (
                <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/60 backdrop-blur-sm">
                    <div className="bg-white rounded-xl shadow-2xl p-7 min-w-[340px] max-w-[95vw] border-2 border-red-300">
                        <div className="flex flex-col gap-5">
                            <h2 className="text-xl font-bold text-red-800 tracking-tight mb-2">Konfirmasi Hapus User</h2>
                            <div className="text-gray-700 mb-4">Apakah Anda yakin ingin menghapus user ini? Tindakan ini tidak dapat dibatalkan.</div>
                            <div className="flex gap-3 mt-2 justify-end">
                                ...
                                <button
                                    type="button"
                                    className="px-4 py-2 rounded-lg bg-gradient-to-r from-red-700 to-purple-700 text-white font-bold hover:from-red-800 hover:to-purple-800 shadow"
